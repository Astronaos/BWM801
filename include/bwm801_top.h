...
namespace bwm801_top
{
	extern "C"
	{
		...
		int bwm801_main(bwm801::main * i_lpcMain, int i_iArg_Count, const char * i_lpszArg_Values[]);
#else
		...
		EXPORT extern INT bwm801_WinMain(bwm801::main * i_lpcMain, HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, INT nCmdShow);
#endif
